---
layout: post
description: An AngularJS seed for Google Closure Compiler
title: A radical new approach to developing AngularJS apps
---

Learn how to use my AngularJS seed with Google Closure Compiler.
...
I've built a seed project called [nghellostyle](https://github.com/zemirco/nghellostyle).
It includes all the proposals mentioned in this post.
The name comes from Google's internal seed project which is unfortunately not online.
